...
const SERVICES = [
  ...
  },
  {
    ...
    details: ['1:1 engagement — not group sessions', 'Career transition and pivot support', 'Senior professionals and emerging leaders', 'Available virtually, nationwide'],
  },
  {
    id: 'consulting',
    badge: 'w-badge-hyd',
